...
@section('isihalaman')
    ...
    <h3 class="page-title">Data Peminjaman Buku Perpus MOKLET</h3>
            ...
            @foreach ($pinjam as $index=>$p)
                <tr>
                    ...
                    <td align="center">
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalPinjamEdit{{$p->id_pinjam}}">
                            Edit
                        </button>
