...
@section('isihalaman')
    ...
    <h3 class="page-title">Daftar Buku Perpus MOKLET</h3>
            ...
            @foreach ($buku as $index=>$bk)
                <tr>
                    ...
                    <td align="center">
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalBukuEdit{{$bk->id_buku}}">
                            Edit
                        </button>
